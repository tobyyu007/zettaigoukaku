...
class quizViewController: NSViewController, NSTextFieldDelegate {
    ...
    var todayQuizzedzettaigoukakuCount = 0 // 今天學習的單字數量
    ...
    override func viewDidLoad() {
        ...
        if userDefault.value(forKey: "date") as? Date != nil && userDefault.value(forKey: "todayQuizzedzettaigoukakuCount") as? Int != nil
        {
            ...
            {
                todayQuizzedzettaigoukakuCount = 0
            }
            else // 今天學習的數量
            {
                let pastCount = userDefault.value(forKey: "todayQuizzedzettaigoukakuCount") as! Int
                todayQuizzedzettaigoukakuCount += pastCount
            }
        }
        else
        {
            ...
            self.userDefault.setValue(todayQuizzedzettaigoukakuCount, forKey: "todayQuizzedzettaigoukakuCount")
        }
    }
    ...
    func resetAllData() // 重設所有設定
    {
        ...
        quizViewController.currentzettaigoukakuIndex = 0 // 現在測驗的單字索引
        ...
        quizViewController.currentzettaigoukakuIndex = 0
    }
    ...
    @IBAction func displayNextButton(_ sender: Any) {
        // 下一步按鍵
        todayQuizzedzettaigoukakuCount += searchResults.count
        // 顯示項目
    ...
    static var currentzettaigoukakuIndex = 0 // 現在測驗的單字索引
    ...
    @IBAction func nextVocabularyButtonClicked(_ sender: Any) // 下一個單字按鈕
    {
        if nextVocabularyButton.title == "完成"
        {
            ...
            if quizJapaneseCheckBox.state == .on // 日文
            {
                answer[quizViewController.currentzettaigoukakuIndex][0] = quizVocabularyTextField.stringValue
            }
            if quizKanaCheckBox.state == .on // 假名
            {
                answer[quizViewController.currentzettaigoukakuIndex][1] = quizKanaTextField.stringValue
            }
            if quizJapaneseDefinitionCheckBox.state == .on // 日文解釋
            {
                answer[quizViewController.currentzettaigoukakuIndex][2] = quizJapaneseDefinitionTextField.stringValue
            }
            if quizChineseDefinitionCheckBox.state == .on // 中文解釋
            {
                answer[quizViewController.currentzettaigoukakuIndex][3] = quizChineseDefinitionTextField.stringValue
            }
            
            var checkIndex = 0

            for i in 0...quizViewController.currentzettaigoukakuIndex
            {
        ...
        else // 顯示下一個
        {
            ...
            quizViewController.currentzettaigoukakuIndex += 1
            previousVocabularyButton.isEnabled = true
            displayVocabulary.stringValue = searchResults[quizViewController.currentzettaigoukakuIndex].volcabulary
            displayKana.stringValue = searchResults[quizViewController.currentzettaigoukakuIndex].kana
            displayJapaneseDescription.stringValue = searchResults[quizViewController.currentzettaigoukakuIndex].japaneseDefinition
            displayType.stringValue = searchResults[quizViewController.currentzettaigoukakuIndex].type
            displayLevel.stringValue = searchResults[quizViewController.currentzettaigoukakuIndex].level
            displayChineseDefinition.stringValue = searchResults[quizViewController.currentzettaigoukakuIndex].chineseDefinition
            
            if quizViewController.currentzettaigoukakuIndex+1 > searchResults.count-1 // 最後一個單字
            {
                nextVocabularyButton.title = "完成"
            }
    ...
    @IBAction func previousVocabularyButtonClicked(_ sender: Any) // 上一個單字按鈕
    {
        ...
        if quizViewController.currentzettaigoukakuIndex == 0 // 第一個單字
        {
            previousVocabularyButton.isEnabled = false
        }
