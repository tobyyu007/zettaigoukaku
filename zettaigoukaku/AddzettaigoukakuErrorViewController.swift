//
//  AddzettaigoukakuErrorViewController.swift
//  zettaigoukaku
//
...
class AddzettaigoukakuErrorViewController: NSViewController {
    ...
    override func viewDidLoad() {
        ...
        switch AddzettaigoukakuErrorViewController.errorTitle {
        case "adding":
        ...
        switch AddzettaigoukakuErrorViewController.errorContent {
        case "noData":
    ...
    {
        // 關閉警告視窗
        self.dismiss(AddzettaigoukakuErrorViewController.self)
    }
