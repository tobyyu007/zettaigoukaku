...
class learnViewController: NSViewController, NSTextFieldDelegate {
    ...
    var todayLearnedzettaigoukakuCount = 0 // 今天學習的單字數量
    ...
    override func viewDidLoad() {
        ...
        if userDefault.value(forKey: "date") as? Date != nil && userDefault.value(forKey: "todayLearnedzettaigoukakuCount") as? Int != nil
        {
            ...
            {
                todayLearnedzettaigoukakuCount = 0
            }
            else // 今天學習的數量
            {
                let pastCount = userDefault.value(forKey: "todayLearnedzettaigoukakuCount") as! Int
                todayLearnedzettaigoukakuCount += pastCount
            }
        }
        else
        {
            ...
            self.userDefault.setValue(todayLearnedzettaigoukakuCount, forKey: "todayLearnedzettaigoukakuCount")
        }
    }
    ...
    @IBAction func displayNextButton(_ sender: Any) {
        // 下一步按鍵
        todayLearnedzettaigoukakuCount += searchResults.count
        learnedVocabularyCountText.stringValue = String(todayLearnedzettaigoukakuCount) + " 個"
    ...
    var currentzettaigoukakuIndex = 0 // 現在顯示的單字索引
    let starImageFilled = #imageLiteral(resourceName: "starFill")
    let starImageEmpty = #imageLiteral(resourceName: "starEmpty")
    ...
    @IBAction func nextVocabularyButtonClicked(_ sender: Any) // 下一個單字按鈕
    {
        ...
        {
            currentzettaigoukakuIndex += 1
            previousVocabularyButton.isEnabled = true
            pageDisplay.stringValue = "P" + String(searchResults[currentzettaigoukakuIndex].page)
            volcabularyDisplay.stringValue = searchResults[currentzettaigoukakuIndex].volcabulary
            kanaDisplay.stringValue = searchResults[currentzettaigoukakuIndex].kana
            japaneseDefinitionDisplay.stringValue = searchResults[currentzettaigoukakuIndex].japaneseDefinition
            chineseDefinitionDisplay.stringValue = searchResults[currentzettaigoukakuIndex].chineseDefinition
            typeDisplay.stringValue = searchResults[currentzettaigoukakuIndex].type
            japaneseExampleDisplay.stringValue = searchResults[currentzettaigoukakuIndex].sentence
            chineseExampleDisplay.stringValue = searchResults[currentzettaigoukakuIndex].sentence_chinese
            levelDisplay.stringValue = searchResults[currentzettaigoukakuIndex].level
            
            if searchResults[currentzettaigoukakuIndex].star // 有標記
            {
                starButtonDisplay.image = starImageFilled
                starImageName = "filled"
            }
            ...
            if currentzettaigoukakuIndex+1 > searchResults.count-1 // 最後一個單字
            {
                nextVocabularyButton.title = "完成"
            }
        }
    ...
    @IBAction func previousVocabularyButtonClicked(_ sender: Any) // 上一個單字按鈕
    {
        ...
        if currentzettaigoukakuIndex == 0 // 第一個單字
        {
            previousVocabularyButton.isEnabled = false
        }
    }
